 ...
 * @author ASUS
 */
public class Sd_Mtk1 extends javax.swing.JFrame {

    /**
     * Creates new form Materi10
     */
    ...
    public Sd_Mtk1() {
        ...
        try {
            Koneksi.konek();
            ResultSet res = Koneksi.konek.createStatement().executeQuery("SELECT materi FROM sd WHERE id_sd = '7'");
            ...
            Logger.getLogger(Sd_Mtk1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("MTK -> Operasi Hitung Bilangan Bulat");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sd_Mtk1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
