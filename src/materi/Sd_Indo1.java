 ...
 * @author ASUS
 */
public class Sd_Indo1 extends javax.swing.JFrame {
    ...
    public Sd_Indo1() {
        ...
        try {
            Koneksi.konek();
            ResultSet res = Koneksi.konek.createStatement().executeQuery("SELECT materi FROM sd WHERE id_sd = '5'");
            ...
            Logger.getLogger(Sd_Indo1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        homePanel.setPreferredSize(new java.awt.Dimension(155, 42));
        ...
        jTextField1.setText("BAHASA INDONESIA -> Berpidato");
        ...
        MateriTF.setRows(5);
        jScrollPane2.setViewportView(MateriTF);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sd_Indo1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
