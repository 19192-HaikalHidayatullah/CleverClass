 ...
 * @author ASUS
 */
public class Sd_Ipa2 extends javax.swing.JFrame {

    /**
     * Creates new form Materi11
     */
    ...
    public Sd_Ipa2() {
            ...
            try {
            Koneksi.konek();
            ResultSet res = Koneksi.konek.createStatement().executeQuery("SELECT materi FROM sd WHERE id_sd = '2'");
            ...
            Logger.getLogger(Sd_Ipa2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("IPA -> Tata Surya");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sd_Ipa2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
