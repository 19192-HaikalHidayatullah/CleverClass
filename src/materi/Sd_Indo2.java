 ...
 * @author ASUS
 */
public class Sd_Indo2 extends javax.swing.JFrame {

    /**
     * Creates new form Materi26
     */
    ...
    public Sd_Indo2() {
        ...
        try {
            Koneksi.konek();
            ResultSet res = Koneksi.konek.createStatement().executeQuery("SELECT materi FROM sd WHERE id_sd = '4'");
            ...
            Logger.getLogger(Sd_Indo2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("BAHASA INDONESIA -> Menyampaikan Pesan/Informasi");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sd_Indo2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
