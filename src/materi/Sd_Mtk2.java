 ...
 * @author ASUS
 */
public class Sd_Mtk2 extends javax.swing.JFrame {

    /**
     * Creates new form Materi21
     */
    ...
    public Sd_Mtk2() {
        ...
        id = Koneksi.getId();
            ...
            try {
                Koneksi.konek();
                ResultSet res = Koneksi.konek.createStatement().executeQuery("SELECT materi FROM sd WHERE id_sd = '8'");
            ...
            Logger.getLogger(Sd_Mtk2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("MATEMATIKA -> Pengukuran Volume Perwaktu");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sd_Mtk2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
