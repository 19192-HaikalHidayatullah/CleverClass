 ...
 * @author ASUS
 */
public class ListSmpIpa extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListSmpIpa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
