 ...
 * @author ASUS
 */
public class ListSmaMtk extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListSmaMtk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
