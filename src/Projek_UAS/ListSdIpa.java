 ...
 * @author ASUS
 */
public class ListSdIpa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        materi1BT.setText("Perkembangbiakan pada makhluk hidup");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListSdIpa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
